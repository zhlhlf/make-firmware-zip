...
## oneplus 13R
```
abl aop aop_config bluetooth cpucp cpucp_dtb devcfg engineering_cdt featenabler hyp imagefv keymaster modem oplus_sec oplusstanvbk qupfw recovery shrm splash tz uefi uefisecapp xbl xbl_config xbl_ramdump
```
## oneplus 9R
```
